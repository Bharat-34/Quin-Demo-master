...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Quin_Demo",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9Quin_Demo11AppDelegate")
...
SWIFT_CLASS("_TtC9Quin_Demo13NetworkHelper")
...
SWIFT_CLASS("_TtC9Quin_Demo18NextViewController")
@interface NextViewController : UIViewController
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified authorsImage;
...
SWIFT_CLASS("_TtC9Quin_Demo13SceneDelegate")
...
SWIFT_CLASS("_TtC9Quin_Demo13TableViewCell")
...
SWIFT_CLASS("_TtC9Quin_Demo14ViewController")
...
@interface ViewController (SWIFT_EXTENSION(Quin_Demo)) <UITableViewDataSource, UITableViewDelegate>
